...
?>
    ...
    <div style="background-color: #93faf1; width: 60%; margin-left: 20%; margin-top: 0px; ">
        <br/><br/>
    <form method="post" action="skill.php">
        <table align="center" bgcolor="beige" width="50%">
        <tr>
    ...
    <?php
     ...
     ?>
        ...
        <input type="submit" name="asses" value="Faculty details"/><br/><br/>
            </td>
