...
<table width="100%" border="0" cellspacing="01" cellpadding="01">
  ...
  <tr>
    ...
    <td><select name="stream" style="width: 13em; height: 2em; font-size: 15px; ">
         ...
         <option value="CSE1" <?php if($row['stream']=='CSE1') echo 'selected="selected"'; ?>>CSE1</option>
        <option value="CSE2" <?php if($row['stream']=='CSE2') echo 'selected="selected"'; ?>>CSE2</option>        
        </select></td>
    <td>&nbsp;</td>
  </tr>
